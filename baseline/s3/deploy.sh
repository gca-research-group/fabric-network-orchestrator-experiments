...
compose_up -f "${OUTPUT_DIR}/network.yml" -f "${OUTPUT_DIR}/org3.${DOMAIN}/tools.${DOMAIN}.yml"

echo "==> Generate Genesis"
docker_exec "tools.org1.${DOMAIN}" sh -c "configtxgen -outputBlock /opt/gopath/src/github.com/hyperledger/fabric/channels/channel1.block -profile TwoOrgsProfile -channelID channel1 -configPath /opt/gopath/src/github.com/hyperledger/fabric/"
docker_exec "tools.org1.${DOMAIN}" sh -c "configtxgen -outputBlock /opt/gopath/src/github.com/hyperledger/fabric/channels/channel2.block -profile TwoOrgsProfile -channelID channel2 -configPath /opt/gopath/src/github.com/hyperledger/fabric/"
docker_exec "tools.org1.${DOMAIN}" sh -c "configtxgen -outputBlock /opt/gopath/src/github.com/hyperledger/fabric/channels/channel3.block -profile AllOrgsProfile -channelID channel3 -configPath /opt/gopath/src/github.com/hyperledger/fabric/"
...
docker_exec "tools.org1.${DOMAIN}" sh -c "osnadmin channel join \
  --channelID channel1 \
  --config-block /opt/gopath/src/github.com/hyperledger/fabric/channels/channel1.block \
...
docker_exec "tools.org1.${DOMAIN}" sh -c "osnadmin channel join \
  --channelID channel2 \
  --config-block /opt/gopath/src/github.com/hyperledger/fabric/channels/channel2.block \
  -o orderer.org1.${DOMAIN}:7053 \
  --ca-file /opt/gopath/src/github.com/hyperledger/fabric/org1.${DOMAIN}/ordererOrganizations/org1.${DOMAIN}/orderers/orderer.org1.${DOMAIN}/tls/ca.crt \
  --client-cert /opt/gopath/src/github.com/hyperledger/fabric/org1.${DOMAIN}/ordererOrganizations/org1.${DOMAIN}/orderers/orderer.org1.${DOMAIN}/tls/server.crt \
  --client-key /opt/gopath/src/github.com/hyperledger/fabric/org1.${DOMAIN}/ordererOrganizations/org1.${DOMAIN}/orderers/orderer.org1.${DOMAIN}/tls/server.key"
...
docker_exec "tools.org1.${DOMAIN}" sh -c "osnadmin channel join \
  --channelID channel3 \
  --config-block /opt/gopath/src/github.com/hyperledger/fabric/channels/channel3.block \
  -o orderer.org1.${DOMAIN}:7053 \
  --ca-file /opt/gopath/src/github.com/hyperledger/fabric/org1.${DOMAIN}/ordererOrganizations/org1.${DOMAIN}/orderers/orderer.org1.${DOMAIN}/tls/ca.crt \
  --client-cert /opt/gopath/src/github.com/hyperledger/fabric/org1.${DOMAIN}/ordererOrganizations/org1.${DOMAIN}/orderers/orderer.org1.${DOMAIN}/tls/server.crt \
  --client-key /opt/gopath/src/github.com/hyperledger/fabric/org1.${DOMAIN}/ordererOrganizations/org1.${DOMAIN}/orderers/orderer.org1.${DOMAIN}/tls/server.key"
...
docker_exec "tools.org2.${DOMAIN}" peer channel fetch newest \
  /opt/gopath/src/github.com/hyperledger/fabric/channels/channel1.block \
  -c channel1 \
...
docker_exec "tools.org2.${DOMAIN}" peer channel fetch newest \
  /opt/gopath/src/github.com/hyperledger/fabric/channels/channel2.block \
  -c channel2 \
  -o "orderer.org1.${DOMAIN}:7050" \
  --tls \
  --cafile "/opt/gopath/src/github.com/hyperledger/fabric/org1.${DOMAIN}/ordererOrganizations/org1.${DOMAIN}/orderers/orderer.org1.${DOMAIN}/tls/ca.crt"
...
docker_exec "tools.org2.${DOMAIN}" peer channel fetch newest \
  /opt/gopath/src/github.com/hyperledger/fabric/channels/channel3.block \
  -c channel3 \
  -o "orderer.org1.${DOMAIN}:7050" \
  --tls \
  --cafile "/opt/gopath/src/github.com/hyperledger/fabric/org1.${DOMAIN}/ordererOrganizations/org1.${DOMAIN}/orderers/orderer.org1.${DOMAIN}/tls/ca.crt"
...
docker_exec \
  ...
  "tools.org1.${DOMAIN}" peer channel join -b /opt/gopath/src/github.com/hyperledger/fabric/channels/channel1.block
...
docker_exec \
  ...
  -e CORE_PEER_LOCALMSPID="Org1MSP" \
  -e CORE_PEER_MSPCONFIGPATH="/opt/gopath/src/github.com/hyperledger/fabric/org1.${DOMAIN}/peerOrganizations/org1.${DOMAIN}/users/Admin@org1.${DOMAIN}/msp" \
  "tools.org1.${DOMAIN}" peer channel join -b /opt/gopath/src/github.com/hyperledger/fabric/channels/channel2.block
...
docker_exec \
  ...
  -e CORE_PEER_LOCALMSPID="Org1MSP" \
  -e CORE_PEER_MSPCONFIGPATH="/opt/gopath/src/github.com/hyperledger/fabric/org1.${DOMAIN}/peerOrganizations/org1.${DOMAIN}/users/Admin@org1.${DOMAIN}/msp" \
  "tools.org1.${DOMAIN}" peer channel join -b /opt/gopath/src/github.com/hyperledger/fabric/channels/channel3.block
...
docker_exec \
  ...
  "tools.org2.${DOMAIN}" peer channel join -b /opt/gopath/src/github.com/hyperledger/fabric/channels/channel1.block
...
docker_exec \
  ...
  -e CORE_PEER_LOCALMSPID="Org2MSP" \
  -e CORE_PEER_MSPCONFIGPATH="/opt/gopath/src/github.com/hyperledger/fabric/org2.${DOMAIN}/peerOrganizations/org2.${DOMAIN}/users/Admin@org2.${DOMAIN}/msp" \
  "tools.org2.${DOMAIN}" peer channel join -b /opt/gopath/src/github.com/hyperledger/fabric/channels/channel2.block
...
docker_exec \
  ...
  -e CORE_PEER_LOCALMSPID="Org2MSP" \
  -e CORE_PEER_MSPCONFIGPATH="/opt/gopath/src/github.com/hyperledger/fabric/org2.${DOMAIN}/peerOrganizations/org2.${DOMAIN}/users/Admin@org2.${DOMAIN}/msp" \
  "tools.org2.${DOMAIN}" peer channel join -b /opt/gopath/src/github.com/hyperledger/fabric/channels/channel3.block
...
docker_exec \
  ...
  "tools.org3.${DOMAIN}" peer channel join -b /opt/gopath/src/github.com/hyperledger/fabric/channels/channel3.block
